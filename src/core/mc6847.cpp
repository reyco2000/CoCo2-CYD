 ...
 * =============================================================
 *  File   : mc6847.cpp
 *  Module : MC6847 Video Display Generator emulation — scanline rendering to palette index buffer
 * =============================================================
 */
...
// raw output. Since we render to a TFT (no NTSC artifacts), we map CSS=1
...
// NTSC artifact color approximation for TFT display:
